...
const OffersSection = () => {
  ...
  useEffect(() => {
    const loadOffers = async () => {
      try {
        setLoading(true);
        const realOffers = await getRealOffers('car');
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
            Des formules transparentes, sans frais cachés, adaptées à votre conduite et votre budget.
          </motion.p>
        ...
        >
          ...
          <div className="flex items-center gap-3 text-slate-400">
            ...
            <span className="font-medium">Attestation Immédiate</span>
          </div>
          <div className="flex items-center gap-3 text-slate-400">
            <Award className="w-6 h-6 text-blue-500" />
            <span className="font-medium">Service Client Élu 2024</span>
          </div>
        </motion.div>
      </div>
    </motion.section>
